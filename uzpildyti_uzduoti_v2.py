...
Skaito naujai parsisiųstą šabloną iš Downloads ir išsaugo užpildytą versiją.
"""
import sys
...
ORIGINAL = r"C:\Users\astij\Downloads\Profesines_praktikos_individuali_uzduotis.docx"
NAUJAS = r"C:\Users\astij\Downloads\Profesines_praktikos_individuali_uzduotis_UZPILDYTA.docx"
...
# Diagnostika - parodyk pradini turini
print("Pradinis dokumento turinys:")
...
print("                      (Noriūnų J. Černiaus skyrius)")
print("  Mokyklos vadovas:   Rita Grinevičienė")
print("  EIF vadovas:        doc. dr. R. Tumasonis")
